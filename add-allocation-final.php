...
if(isset($_POST['operation']) && $_REQUEST['operation']=='insert'){
	if($dbf->checkSecurity($_SERVER)){
		...
		if($chef_id=="" || $job_name=="" || $job_location=="" || $allocation_date==""){
			...
			/*************Notification end***************/
			header("Location:add-allocation?msg=3");exit;
		}
	}
}
?>
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="chef_id" id="chef_id">
                        ...
                        <option value="<?php echo $chef_det['chefs_id']; ?>" <?php if($chef_det['chefs_id']==$_REQUEST['chef_id']){ echo "selected"; } ?>><?php echo $chef_det['chefs_name']; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12"  style="max-height:350px; overflow:auto;">
                      <div class="form-group">
                        <table class="table table-bordered">
                          ...
                          ?>
                                <td><input type="checkbox" name="sup_id<?php echo $sup_count; ?>" id="sup_id<?php echo $sup_count; ?>" value="<?php echo $sup_det['sid']; ?>"> &nbsp; <?php echo $sup_det['full_name']; ?></td>
                                
                                <td><input class="form-control" name="sup_ac_no<?php echo $sup_count; ?>" id="sup_ac_no<?php echo $sup_count; ?>" autocomplete="off"></td>
                         <?php
                         if($sup_count%2 == 0){ echo '</tr>';}
